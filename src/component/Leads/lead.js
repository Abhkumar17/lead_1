                    ...
                    <div className="card mb-4 abc filterlead"  >
                        <div className="card-body text-center">
                            ...
                            <div className="filter_btn d-flex justify-content-start  align-items-baseline my-4 ml-3">
                                <Link to="#" target="_blank"  ><button type="button" className="btn btn-primary mr-20 ">
                                    Apply Filter</button></Link>
                                <Link to="#" target="_blank"><button type="button" className="btn btn-primary mr-20 btn-clear">Clear</button></Link>
                            </div>
                        </div>
                    </div>
                </div>
...
function Table1(props) {
    ...
    return ( <div className="table-responsive text-nowrap">
        <Link to='lead_overview'> lead view</Link>
